...
!     ..
!     .. Local Arrays ..
    COMPLEX*16, allocatable, dimension(:,:) :: WORK13, WORK31
    !COMPLEX*16         WORK13( LDWORK, NBMAX ), &
    !WORK31( LDWORK, NBMAX )
!     ..
!     .. External Functions ..
    INTEGER, EXTERNAL ::            ILAENV, IZAMAX
